...
exports.logindata = (req, res) => {
    if (Object.keys(req.body).length === 0) {
        ...
        authmodel.loginFunc(modelclass, (err, data) => {
            if (err) {
                res.json({
                    status: "10",
                    message: "error",
...
exports.listalldata = (req, res) => {
    ...
    authmodel.listallFunc(null, (err, data) => {
       if (err) {
            res.json({
                status: "10",
                message: "error",
...
exports.dltdata = (req, res) => {
    if (Object.keys(req.body).length === 0) {
        ...
        authmodel.dltFunc(modelclass, (err, data) => {
            if (err) {
                res.json({
                    status: "10",
                    message: "error",
...
exports.update = (req, res) => {
    if (Object.keys(req.body).length === 0) {
        ...
        authmodel.updateFunc(modelclass, (err, data) => {
            if (err) {
                res.json({
                    status: "10",
                    message: "error",
